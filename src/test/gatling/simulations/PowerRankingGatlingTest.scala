...
/**
 * Performance test for the PowerRanking entity.
 */
class PowerRankingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PowerRanking entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all powerRankings")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created powerRanking")
                .get("${new_powerRanking_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created powerRanking")
            .delete("${new_powerRanking_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
