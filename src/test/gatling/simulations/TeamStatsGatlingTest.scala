...
/**
 * Performance test for the TeamStats entity.
 */
class TeamStatsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the TeamStats entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created teamStats")
                .get("${new_teamStats_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created teamStats")
            .delete("${new_teamStats_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
