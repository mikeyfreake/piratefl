...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "piratesfl@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "piratesfl API";

        private String description = "piratesfl API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "piratesfl";
