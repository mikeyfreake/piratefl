(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('piratesflApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-piratesflApp-error');
                var entityKey = httpResponse.headers('X-piratesflApp-params');
                if (errorHeader) {
